...
public abstract class BaseTest {
  ...
  protected static final ManagedResource<Timer> timerResource = ManagedResource.external(timerService);
  ...
  protected static final long INVALIDATION_TIMEOUT = (
      (long) (INVALID_PINGS + 1) *
          (PING_INTERVAL + TIMER_ERROR_MS)
  );
  protected static final long RESTORE_TIMEOUT = (WINDOW_SIZE + 1) * (PING_INTERVAL + TIMER_ERROR_MS);
  protected static final ArrayValue emptyArgs = ValueFactory.emptyArray();
  protected static final HeartbeatOpts HEARTBEAT_OPTS = HeartbeatOpts
      .getDefault()

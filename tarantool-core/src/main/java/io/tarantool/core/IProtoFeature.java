...
public enum IProtoFeature {
  ...
  WATCH_ONCE,
  /**
   * Tuple format in DML request responses support: Tuples in IPROTO_DATA response field are encoded as MP_TUPLE and
   * tuple format is sent in IPROTO_TUPLE_FORMATS field. Were introduced in protocol version 7 (Tarantool 3.0.0).
   */
  DML_TUPLE_EXTENSION,

  /**
   * Tuple format in call and eval request responses support: Tuples in IPROTO_DATA response field are encoded as
   * MP_TUPLE and tuple formats are sent in IPROTO_TUPLE_FORMATS field. Were introduced in protocol version 7 (Tarantool
   * 3.0.0).
   */
   ...
   * Were introduced in protocol version 7 (Tarantool 3.0.0).
   */

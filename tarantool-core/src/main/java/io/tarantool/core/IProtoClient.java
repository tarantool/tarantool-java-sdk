...
public interface IProtoClient {
  ...
  CompletableFuture<IProtoResponse> authorize(String user,
      String password);
  ...
  CompletableFuture<IProtoResponse> select(int spaceId,
      int indexId,
      ArrayValue key,
      int limit,
      int offset,
  ...
  CompletableFuture<IProtoResponse> select(Integer spaceId,
      String spaceName,
      Integer indexId,
      String indexName,
      ArrayValue key,
  ...
  CompletableFuture<IProtoResponse> insert(int spaceId,
      ArrayValue tuple);

  CompletableFuture<IProtoResponse> insert(int spaceId, byte[] tuple);

  CompletableFuture<IProtoResponse> insert(Integer spaceId,
      String spaceName,
      ArrayValue tuple,
      IProtoRequestOpts opts);
  ...
  CompletableFuture<IProtoResponse> replace(int spaceId,
      ArrayValue tuple);

  CompletableFuture<IProtoResponse> replace(int spaceId,
      byte[] tuple);

  CompletableFuture<IProtoResponse> replace(Integer spaceId,
      String spaceName,
      ArrayValue tuple,
      IProtoRequestOpts opts);
  ...
  CompletableFuture<IProtoResponse> update(int spaceId,
      int indexId,
      ArrayValue key,
  ...
  CompletableFuture<IProtoResponse> update(Integer spaceId,
  ...
  CompletableFuture<IProtoResponse> upsert(int spaceId,
      int indexBase,
      ArrayValue tuple,
      ArrayValue operations);
  ...
  CompletableFuture<IProtoResponse> upsert(Integer spaceId,
      final String spaceName,
      Integer indexBaseId,
      ArrayValue tuple,
      ArrayValue operations,
  ...
  CompletableFuture<IProtoResponse> delete(int spaceId,
      int indexId,
      ArrayValue key);
  ...
  CompletableFuture<IProtoResponse> delete(Integer spaceId,
      final String spaceName,
      Integer indexId,
      final String indexName,
      ArrayValue key,
  ...
  CompletableFuture<IProtoResponse> call(String function,
      ArrayValue args);
  ...
  CompletableFuture<IProtoResponse> eval(String expression,
      ArrayValue args);
  ...
  CompletableFuture<IProtoResponse> execute(long statementId,
      ArrayValue sqlBind,
      ArrayValue options);
  ...
  CompletableFuture<IProtoResponse> execute(String statementText,
      ArrayValue sqlBind,
      ArrayValue options);
  ...
  CompletableFuture<IProtoResponse> begin(Long streamId,
      long timeout,
  ...
  CompletableFuture<IProtoResponse> id(int protocolVersion,
  ...
  IProtoClient onClose(ConnectionCloseEvent event,
      BiConsumer<IProtoClient, Throwable> handler);

 ...
 * href="https://www.tarantool.io/en/tdg/latest/">tdg</a> product.
 *
...
public interface TarantoolDataGridSpace extends TarantoolSpace {
   ...
   *     TarantoolDataGridSpace} interface.
   * @return {@link CompletableFuture} object. If successful - future is completed successfully with
   *     the inserted tuple represented as map of field names and values, otherwise this future will
   *     be completed exceptionally by exception.
   */
  CompletableFuture<Map<?, ?>> put(Object tuple);

  /**
   * Inserts a tuple into the space with additional options.
   *
   * <p>Example of usage:
   *
   * <blockquote>
   ...
   * @param tuple tuple object for insertion. To create tuple object class follow example in {@link
   *     TarantoolDataGridSpace} interface.
   * @param options additional options for the operation. Can be used to pass TDG-specific options
   *     such as {"skip_result": true} to skip returning the result
   * @param context additional context for the operation. Can be used to pass TDG-specific context
   *     such as authentication information or other metadata
   * @return {@link CompletableFuture} object. If successful - future is completed successfully with
   *     the inserted tuple represented as map of field names and values, otherwise this future will
   *     be completed exceptionally by exception.
   */
  CompletableFuture<Map<?, ?>> put(
      Object tuple, OnlyKeyValueOptions options, Map<String, Object> context);

  /**
   * Retrieves a tuple from the space by its key.
   *
   * <p>Example of usage:
   *
   * <blockquote>
   ...
   * @return {@link CompletableFuture} object. If successful - future is completed successfully with
   *     the retrieved tuple represented as map of field names and values, otherwise this future
   *     will be completed exceptionally by exception.
   */
  CompletableFuture<Map<?, ?>> get(Object key);

  /**
   * Retrieves a tuple from the space by its key with additional options.
   *
   * <p>Example of usage:
   *
   * <blockquote>
  ...
  /**
   * Updates tuples in the space matching the specified filters.
   *
   * <p>Example of usage:
   *
   * <blockquote>
   ...
   * </blockquote>
   *
   * @param filters list of filter conditions to identify tuples to update. Each filter is a list
   *     with format: [field_name, operator, value] where operator can be "==", "!=", ">", "<",
   *     ">=", "<="
   * @param updaters list of update operations to apply. Each operation is a list with format:
   *     [operation_type, field_name, value] where operation_type can be "set", "add", "sub", "mul",
   *     "div", etc.
   * @return {@link CompletableFuture} object. If successful - future is completed successfully with
   *     the updated tuples represented as list of maps of field names and values, otherwise this
   *     future will be completed exceptionally by exception.
   */
  CompletableFuture<List<Map<?, ?>>> update(List<List<?>> filters, List<List<?>> updaters);

  /**
   * Updates tuples in the space matching the specified filters with additional options.
   *
   * <p>Example of usage:
   *
   * <blockquote>
   ...
   *     future will be completed exceptionally by exception.
   */
  CompletableFuture<List<Map<?, ?>>> update(
      List<List<?>> filters,
      List<List<?>> updaters,
  ...
  /**
   * Deletes tuples from the space matching the specified filters.
   *
   * <p>Example of usage:
   *
   * <blockquote>
   ...
   * </blockquote>
   *
   * @param filters list of filter conditions to identify tuples to delete. Each filter is a list
   *     with format: [field_name, operator, value] where operator can be "==", "!=", ">", "<",
   *     ">=", "<="
   * @return {@link CompletableFuture} object. If successful - future is completed successfully with
   *     the deleted tuples represented as list of maps of field names and values, otherwise this
   *     future will be completed exceptionally by exception.
   */
  CompletableFuture<List<Map<?, ?>>> delete(List<List<?>> filters);

  /**
   * Deletes tuples from the space matching the specified filters with additional options.
   *
   * <p>Example of usage:
   *
   * <blockquote>
  ...
  /**
   * Finds tuples in the space matching the specified filters.
   *
   * <p>Example of usage:
   *
   * <blockquote>
   ...
   * </blockquote>
   *
   * @param filters list of filter conditions to identify tuples to find. Each filter is a list with
   *     format: [field_name, operator, value] where operator can be "==", "!=", ">", "<", ">=",
   *     "<="
   * @return {@link CompletableFuture} object. If successful - future is completed successfully with
   *     the found tuples represented as list of maps of field names and values, otherwise this
   *     future will be completed exceptionally by exception.
   */
  CompletableFuture<List<Map<?, ?>>> find(List<List<?>> filters);

  /**
   * Finds tuples in the space matching the specified filters with additional options.
   *
   * <p>Example of usage:
   *
   * <blockquote>
  ...
  /**
   * Counts tuples in the space matching the specified filters.
   *
   * <p>Example of usage:
   *
   * <blockquote>
   ...
   * </blockquote>
   *
   * @param filters list of filter conditions to identify tuples to count. Each filter is a list
   *     with format: [field_name, operator, value] where operator can be "==", "!=", ">", "<",
   *     ">=", "<="
   * @return {@link CompletableFuture} object. If successful - future is completed successfully with
   *     the count of matching tuples, otherwise this future will be completed exceptionally by
   *     exception.
   */
  CompletableFuture<Integer> count(List<List<?>> filters);

  /**
   * Counts tuples in the space matching the specified filters with additional options.
   *
   * <p>Example of usage:
   *
   * <blockquote>

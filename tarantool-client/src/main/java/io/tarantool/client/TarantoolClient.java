...
public interface TarantoolClient extends AutoCloseable {
  ...
  /** Default instance group tag. */
  String DEFAULT_TAG = "default";

  /** Default number of netty threads. */
  int DEFAULT_CONNECTION_THREADS_NUMBER = 0;

  /** Default connection timeout. */
  long DEFAULT_CONNECTION_TIMEOUT = 3_000L;

  /** Default time after which reconnect occurs. */
  long DEFAULT_RECONNECT_AFTER = 1_000L;

  /** Default graceful shutdown value. */
  boolean DEFAULT_GRACEFUL_SHUTDOWN = true;

  /**
   * Function returns {@link TarantoolSpace space} with the name specified as the input argument.
   *
  ...
  /**
   * The method calls stored procedure like the function <a
   * href="https://www.tarantool.io/ru/doc/latest/reference/reference_lua/net_box/#lua-function.conn.call">call</a>
   * does. The method makes a remote call similar to func('1', '2', '3'). So {@link #call(String)}
   * represents a remote stored procedure call. {@link #call(String)} returns what it returns
   * function. <i><b>Limitation</b></i>: a called function cannot return a function, for example if
   * <i>func2</i> is defined as <i>function func2 () return func end</i>, then <i>{@link
   * #call(String)}</i> will return the error “error: unsupported Lua type “function”.
   *
   * <p><i><b>Note</b></i>: when calling this method via {@link TarantoolCrudClient} requests sends
   * to router.
   *
   * <p><i><b>Note</b></i>: the return value of the function called through this method must be
   * serializable in msgpack.
   *
   * <p><i><b>Note</b></i>: This method always returns a list of results since Lua functions have
   * multi-return .
   *
   ...
   * @return {@link CompletableFuture} object. If successful - future is completed with a list of
   *     stored procedure result, otherwise this future will be completed exceptionally
   */
   ...
   * href="https://www.tarantool.io/ru/doc/latest/reference/reference_lua/net_box/#lua-function.conn.call">call</a>
   * does. The method makes a remote call similar to func('1', '2', '3'). So {@link #call(String,
   * Class)} represents a remote stored procedure call. {@link #call(String, Class)} returns what it
   * returns function. <i><b>Limitation</b></i>: a called function cannot return a function, for
   * example if <i>func2</i> is defined as <i>function func2 () return func end</i>, then <i> {@link
   * #call(String, Class)}</i> will return the error “error: unsupported Lua type “function”.
   *
   * <p><i><b>Note</b></i>: when calling this method via {@link TarantoolCrudClient} requests sends
   * to router.
   *
   ...
   * href="https://www.tarantool.io/ru/doc/latest/reference/reference_lua/net_box/#lua-function.conn.call">call</a>
   * does. The method makes a remote call similar to func('1', '2', '3'). So {@link #call(String,
   * TypeReference)} represents a remote stored procedure call. {@link #call(String, TypeReference)}
   * returns what it returns function. <i><b>Limitation</b></i>: a called function cannot return a
   * function, for example if <i>func2</i> is defined as <i>function func2 () return func end</i>,
   * then <i>{@link #call(String, TypeReference)}</i> will return the error “error: unsupported Lua
   * type “function”.
   *
   * <p><i><b>Note</b></i>: when calling this method via {@link TarantoolCrudClient} requests sends
   * to router.
   ...
   * @return {@link CompletableFuture} object. If successful - future is completed with procedure
   *     return type, otherwise this future will be completed exceptionally
   */
   ...
   * href="https://www.tarantool.io/ru/doc/latest/reference/reference_lua/net_box/#lua-function.conn.call">call</a>
   * does. The method makes a remote call similar to func('1', '2', '3'). So {@link #call(String,
   * List)} represents a remote stored procedure call. {@link #call(String, List)} returns what it
   * returns function. <i><b>Limitation</b></i>: a called function cannot return a function, for
   * example if <i>func2</i> is defined as <i>function func2 () return func end</i>, then <i>{@link
   * #call(String, List)}</i> will return the error “error: unsupported Lua type “function”.
   *
   * <p><i><b>Note</b></i>: when calling this method via {@link TarantoolCrudClient} requests sends
   * to router.
   *
   ...
   * href="https://www.tarantool.io/ru/doc/latest/reference/reference_lua/net_box/#lua-function.conn.call">call</a>
   * does. The method makes a remote call similar to func('1', '2', '3'). So {@link #call(String,
   * List, Class)} represents a remote stored procedure call. {@link #call(String, List, Class)}
   * returns what it returns function. <i><b>Limitation</b></i>: a called function cannot return a
   * function, for example if <i>func2</i> is defined as <i>function func2 () return func end</i>,
   * then <i>{@link #call(String, List, Class)}</i> will return the error “error: unsupported Lua
   * type “function”.
   *
   * <p><i><b>Note</b></i>: when calling this method via {@link TarantoolCrudClient} requests sends
   * to router.
  ...
  <T> CompletableFuture<TarantoolResponse<List<T>>> call(
      String function, List<?> args, Class<T> entity);

  /**
   * The method calls stored procedure like the function <a
   * href="https://www.tarantool.io/ru/doc/latest/reference/reference_lua/net_box/#lua-function.conn.call">call</a>
   * does. The method makes a remote call similar to func('1', '2', '3'). So {@link #call(String,
   * List, TypeReference)} represents a remote stored procedure call. {@link #call(String, List,
   * TypeReference)} returns what it returns function. <i><b>Limitation</b></i>: a called function
   * cannot return a function, for example if <i>func2</i> is defined as <i>function func2 () return
   * func end</i>, then <i>{@link #call(String, List, TypeReference)}</i> will return the error
  ...
  <T> CompletableFuture<TarantoolResponse<T>> call(
      String function, List<?> args, TypeReference<T> entity);

  /**
   * The method calls stored procedure like the function <a
   * href="https://www.tarantool.io/ru/doc/latest/reference/reference_lua/net_box/#lua-function.conn.call">call</a>
   * does. The method makes a remote call similar to func('1', '2', '3'). So {@link #call(String,
   * List, Options)} represents a remote stored procedure call. {@link #call(String, List, Options)}
   * returns what it returns function. <i><b>Limitation</b></i>: a called function cannot return a
   * function, for example if <i>func2</i> is defined as <i>function func2 () return func end</i>,
   * then <i>{@link #call(String, List, Options)}</i> will return the error “error: unsupported Lua
   * type “function”.
   *
   * <p><i><b>Note</b></i>: when calling this method via {@link TarantoolCrudClient} requests sends
   * to router.
   ...
   *     stored procedure result, otherwise this future will be completed exceptionally
   */
  CompletableFuture<TarantoolResponse<List<?>>> call(String function, List<?> args, Options opts);

  /**
   * The method calls stored procedure like the function <a
   * href="https://www.tarantool.io/ru/doc/latest/reference/reference_lua/net_box/#lua-function.conn.call">call</a>
   * does. The method makes a remote call similar to func('1', '2', '3'). So {@link #call(String,
   * List, Options, Class)} represents a remote stored procedure call. {@link #call(String, List,
   * Options, Class)} returns what it returns function. <i><b>Limitation</b></i>: a called function
   * cannot return a function, for example if <i>func2</i> is defined as <i>function func2 () return
   * func end</i>, then <i>{@link #call(String, List, Options, Class)}</i> will return the error
   * “error: unsupported Lua type “function”.
   *
   * <p><i><b>Note</b></i>: when calling this method via {@link TarantoolCrudClient} requests sends
   * to router.
   ...
   */
  <T> CompletableFuture<TarantoolResponse<List<T>>> call(
      String function, List<?> args, Options opts, Class<T> entity);
   ...
   */
  <T> CompletableFuture<TarantoolResponse<T>> call(
      String function, List<?> args, Object formats, Options opts, TypeReference<T> entity);

  /**
   * The method evaluates Lua expression like the function <a
   * href="https://www.tarantool.io/ru/doc/latest/reference/reference_lua/net_box/#lua-function.conn.eval">eval</a>
   * does. Evaluates and executes an expression in a Lua string, which can be any expression or
   * several expressions. Execute permissions are required.
   *
   * <p><i><b>Note</b></i>: when calling this method via {@link TarantoolCrudClient} requests sent
   * as Lua string will be executed on the router.
   *
   * <p><i><b>Note</b></i>: This method always returns a list of results since Lua functions have
   * multi-return .
   *
   ...
   * @return {@link CompletableFuture} object. If successful - future is completed with a list of
   *     eval result, otherwise this future will be completed exceptionally
   */
   ...
   *     return type, otherwise this future will be completed exceptionally by exception
   */
  ...
  <T> CompletableFuture<TarantoolResponse<List<T>>> eval(
      String expression, List<?> args, Class<T> entity);
  ...
  <T> CompletableFuture<TarantoolResponse<T>> eval(
      String expression, List<?> args, TypeReference<T> entity);
   ...
   *     eval result, otherwise this future will be completed exceptionally
   */
  CompletableFuture<TarantoolResponse<List<?>>> eval(String expression, List<?> args, Options opts);
   ...
   */
  <T> CompletableFuture<TarantoolResponse<List<T>>> eval(
      String expression, List<?> args, Options opts, Class<T> entity);
   ...
   */
  <T> CompletableFuture<TarantoolResponse<T>> eval(
      String expression, List<?> args, Object formats, Options opts, TypeReference<T> entity);

  /**
   * Method sends ping request to Tarantool.
   *
   * <p><i><b>Note</b></i>: when calling this method via {@link TarantoolCrudClient} requests sends
   * to router.
   *
   ...
   * </blockquote>
   *
   * @return {@link CompletableFuture} object. If successful - future is completed with ping request
   *     result, otherwise this future will be completed exceptionally
   */
  CompletableFuture<Boolean> ping();

  /**
   * Method sends ping request with {@link Options options} to Tarantool.
   *
   * <p><i><b>Note</b></i>: when calling this method via {@link TarantoolCrudClient} requests sends
   * to router.
   *
  ...
  /**
   * Method allows to subscribe to events broadcast by Tarantool.
   *
   * <p><i><b>Note</b></i>: when calling this method via {@link TarantoolCrudClient} requests sends
   * to router.
   *
   ...
   * @param callback handler function
   */
  <T> void watch(String key, Consumer<TarantoolResponse<T>> callback, Class<T> entity);
   ...
   * @param callback handler function
   */
  <T> void watch(String key, Consumer<TarantoolResponse<T>> callback, TypeReference<T> entity);

  /**
   * Method allows fetching the value currently associated with a specified notification key without
   ...
   * @param key key of event
   * @return {@link CompletableFuture} object. If successful - future is completed with a list of
   *     broadcast result, otherwise this future will be completed exceptionally
   */
  ...
  /**
   * Method allows to unsubscribe to events broadcast by Tarantool.
   *
   * <p><i><b>Note</b></i>: when calling this method via {@link TarantoolCrudClient} requests sends
   * to router.
   *
  ...
  /**
   * Method closes all connection from client to Tarantool.
   *

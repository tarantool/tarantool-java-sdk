...
/**
 * <p>Class implements factory to create Tarantool clients.</p>
 *
...
public class TarantoolFactory {
  ...
  /**
   * <p>Creates {@link TarantoolFactory} object.</p>
   */
  ...
  private static void initMetricsIfNeeded() {
    if (metricsRegistry != null && !metricsRegistered) {
      ...
      responseSuccess = Counter
          ...
          .register(metricsRegistry);
      responseErrors = Counter
          .builder("response.errors")
          .description("Number of error responses")
          .register(metricsRegistry);
      ignoredResponsesCounter = Counter
          .builder("response.ignored")
  ...
  /**
   * <p>Creates builder for {@link TarantoolBoxClientImpl} class.</p>
   *
  ...
  /**
   * <p>Creates builder for {@link TarantoolCrudClientImpl} class.</p>
   *
  ...
  /**
   * <p>Creates builder for {@link TarantoolDataGridClientImpl} class.</p>
   * <p><b>WARNING: This is a beta version of the client.
   * Some features may not work correctly or may change in future releases.</b></p>
   *

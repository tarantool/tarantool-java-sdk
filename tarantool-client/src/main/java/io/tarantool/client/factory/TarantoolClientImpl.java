...
/**
 * Class implementing {@link TarantoolClient}.
 *
...
abstract class TarantoolClientImpl implements TarantoolClient {
  ...
  /** An object that regulates the load by balancing requests. */
  protected final TarantoolBalancer balancer;

  /** Event loop groups for requests in Netty. */
  ...
  /** Client pool that is used in {@link #balancer}. */
  private final IProtoClientPool pool;

  private final AtomicBoolean isClosed;

  /**
   * Creates {@link TarantoolClientImpl} object with passed arguments.
   *
   * @param groups list of connection groups. {@link InstanceConnectionGroup} is a list of N
   *     connections to one node. See: {@link InstanceConnectionGroup}
  ...
  /**
   * Method converts {@link Options} to {@link IProtoRequestOpts}.
   *
  ...
  /**
   * Method converts {@link IProtoResponse responce} of "ping" request to boolean. If true -
   * Tarantool is available, otherwise - isn't available.
   *
  ...
  @Override
  public <T> CompletableFuture<TarantoolResponse<T>> call(
      String function, TypeReference<T> entity) {
    CompletableFuture<IProtoResponse> future =
        balancer.getNext().thenCompose(c -> c.call(function, ValueFactory.emptyArray()));
  ...
  public CompletableFuture<TarantoolResponse<List<?>>> call(String function, List<?> args) {
    ...
    CompletableFuture<IProtoResponse> future =
        balancer.getNext().thenCompose(c -> c.call(function, rawArgs));

    return TarantoolJacksonMapping.convertFutureResult(future);
  }

  @Override
  public <T> CompletableFuture<TarantoolResponse<List<T>>> call(
  ...
  @Override
  public CompletableFuture<TarantoolResponse<List<?>>> call(
      String function, List<?> args, Options opts) {
    CompletableFuture<IProtoResponse> future =
        balancer
            .getNext()
            .thenCompose(
            ...
            .thenCompose(
                c ->
                    c.call(
                        ...
                        formats == null
                            ? null
                            : TarantoolJacksonMapping.toValueWithKeySerializer(formats),
                        convertOptions(opts)));
  ...
  @Override
  public <T> CompletableFuture<TarantoolResponse<List<T>>> eval(
      String expression, Class<T> entity) {
    CompletableFuture<IProtoResponse> future =
        balancer.getNext().thenCompose(c -> c.eval(expression, ValueFactory.emptyArray()));
  ...
  @Override
  public <T> CompletableFuture<TarantoolResponse<T>> eval(
      String expression, TypeReference<T> entity) {
    CompletableFuture<IProtoResponse> future =
        balancer.getNext().thenCompose(c -> c.eval(expression, ValueFactory.emptyArray()));
  ...
  public CompletableFuture<TarantoolResponse<List<?>>> eval(String expression, List<?> args) {
    CompletableFuture<IProtoResponse> future =
        balancer
            .getNext()
            .thenCompose(c -> c.eval(expression, TarantoolJacksonMapping.toValue(args)));
  ...
  @Override
  public CompletableFuture<TarantoolResponse<List<?>>> eval(
      String expression, List<?> args, Options opts) {
    CompletableFuture<IProtoResponse> future =
        balancer
            .getNext()
            .thenCompose(
  ...
  public CompletableFuture<Boolean> ping(Options opts) {
    CompletableFuture<IProtoResponse> future =
        balancer.getNext().thenCompose(c -> c.ping(convertOptions(opts)));
  ...
  public <T> void watch(String key, Consumer<TarantoolResponse<T>> callback, Class<T> entity) {
    wrappedWatch(
        key, value -> callback.accept(TarantoolJacksonMapping.fromEventData(value, entity)));
  }

  @Override
  public <T> void watch(
      String key, Consumer<TarantoolResponse<T>> callback, TypeReference<T> entity) {
    wrappedWatch(
        key, value -> callback.accept(TarantoolJacksonMapping.fromEventData(value, entity)));
  }
  ...
  @Override
  public <T> CompletableFuture<TarantoolResponse<T>> watchOnce(
      String key, TypeReference<T> entity) {
    return TarantoolJacksonMapping.convertFutureResult(iprotoWatch(key), entity);
  }

...
/**
 * <p>Class extends {@link IProtoCallClusterSpace} class and implementing {@link TarantoolDataGridSpace}.</p>
 ...
 */
public class TarantoolDataGridSpaceImpl extends IProtoCallClusterSpace implements TarantoolDataGridSpace {

  /**
   * <p> Template for repository put function.</p>
   */
  public static final String REPOSITORY_PUT = "repository.put";

  /**
   * <p> Template for repository get function.</p>
   */
  public static final String REPOSITORY_GET = "repository.get";

  /**
   * <p> Template for repository delete function.</p>
   */
  public static final String REPOSITORY_DELETE = "repository.delete";

  /**
   * <p> Template for repository find function.</p>
   */
  public static final String REPOSITORY_FIND = "repository.find";

  /**
   * <p> Template for repository count function.</p>
   */
  public static final String REPOSITORY_COUNT = "repository.count";

  /**
   * <p> Template for repository update function.</p>
   */
  public static final String REPOSITORY_UPDATE = "repository.update";

  private static final OnlyKeyValueOptions DEFAULT_ONLY_KV_OPTIONS = OnlyKeyValueOptions.builder().build();

  /**
   * <p> Template type reference for single result value tdg result.</p>
   */
  private final TypeReference<TDGResponse<Map<?, ?>>> TDG_RESPONSE_MAP
      = new TypeReference<TDGResponse<Map<?, ?>>>() {};

  /**
   * <p> Template type reference for many values tdg result.</p>
   */
  private final TypeReference<TDGResponse<List<Map<?, ?>>>> TDG_RESPONSE_LIST_MAP
      = new TypeReference<TDGResponse<List<Map<?, ?>>>>() {};

  /**
   * <p> Template type reference for single integer tdg result.</p>
   */
  ...
  /**
   * <p> This constructor creates {@link TarantoolDataGridSpaceImpl} based on the passed parameters.</p>
   *
   * @param balancer  see also: {@link #balancer}.
   * @param spaceName see also: {@link #spaceName}.
   */
  public TarantoolDataGridSpaceImpl(TarantoolBalancer balancer, String spaceName, Boolean useTdg1Context,
  ...
  @Override
  public CompletableFuture<Map<?, ?>> put(Object tuple, OnlyKeyValueOptions options, Map<String, Object> context) {
    return tdgCallMultiResult(REPOSITORY_PUT, options, toArgs(tuple, options.getOptions(), context, credentials))
  ...
  public CompletableFuture<Map<?, ?>> get(Object key, OnlyKeyValueOptions options) {
    ...
    return tdgCallSingleResult(REPOSITORY_GET, options, TDG_RESPONSE_MAP,
        toArgs(key, options.getOptions(), credentials));
  }
  ...
  @Override
  public CompletableFuture<List<Map<?, ?>>> update(List<List<?>> filters, List<List<?>> updaters,
      OnlyKeyValueOptions options, Map<String, Object> context) {
    return tdgCallMultiResult(REPOSITORY_UPDATE, options, toArgs(filters, updaters, options.getOptions(),
        context, credentials));
  }
  ...
  @Override
  public CompletableFuture<List<Map<?, ?>>> delete(List<List<?>> filters, OnlyKeyValueOptions options) {
    return tdgCallMultiResult(REPOSITORY_DELETE, options, toArgs(filters, options.getOptions(), credentials));
  }
  ...
  @Override
  public CompletableFuture<List<Map<?, ?>>> find(List<List<?>> filters, OnlyKeyValueOptions options) {
    return tdgCallMultiResult(REPOSITORY_FIND, options, toArgs(filters, options.getOptions(), credentials));
  }
  ...
  public CompletableFuture<Integer> count(List<List<?>> filters, OnlyKeyValueOptions options) {
    return tdgCallSingleResult(REPOSITORY_COUNT, options, TDG_RESPONSE_INTEGER,
  ...
  public CompletableFuture<?> delete(Object key) {
    throw new UnsupportedOperationException("TDG doesn't support delete by PK without index/field name");
  }
  ...
  private CompletableFuture<List<Map<?, ?>>> tdgCallMultiResult(String functionName, Options options, Object... args) {
    return TarantoolJacksonMapping.convertFutureResult(
            iprotoCall(options, functionName, args),
            TDG_RESPONSE_LIST_MAP
        ).thenApply(TarantoolResponse::get)
        .thenApply(TDGResponse::getData);
  }

  private <T> CompletableFuture<T> tdgCallSingleResult(String functionName, Options options,
      TypeReference<TDGResponse<T>> typeReference, Object... args) {
    return TarantoolJacksonMapping.convertFutureResult(
            iprotoCall(options, functionName, args),
            typeReference
        ).thenApply(TarantoolResponse::get)

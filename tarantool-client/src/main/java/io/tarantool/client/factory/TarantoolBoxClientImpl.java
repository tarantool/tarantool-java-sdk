...
/**
 * <p>Class implementing {@link TarantoolClientImpl} and {@link TarantoolBoxClient}.</p>
...
final class TarantoolBoxClientImpl extends TarantoolClientImpl implements TarantoolBoxClient {
  ...
  /**
   * <p> This constructor creates {@link TarantoolBoxClientImpl} based on the passed parameters.</p>
   *
   ...
   *                               managed resource.
   * @param fetchSchema            if {@code true}, then use {@link io.tarantool.schema.TarantoolSchemaFetcher}.
   ...
   * @param ignoreOldSchemaVersion if {@code false}, then client can raise exception on getting old schema version.
   ...
   */
  TarantoolBoxClientImpl(List<InstanceConnectionGroup> groups,
  ...
  /**
   * <p> Creates new builder for {@link TarantoolBoxClientImpl} class.</p>
   *

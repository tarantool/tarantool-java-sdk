 ...
 * <p>Note: Classes that implement this interface work directly with a specific Tarantool instance that the
 * {@link TarantoolBalancer balancer} selects, without referring to Tarantool instance through router.</p>
...
public interface TarantoolBoxSpace extends TarantoolSpace {
  ...
  /**
   * <p>Exception message when trying to use space name and index name in {@code Tarantool version < 3.0.0} with
   * fetcher disabled.</p>
   */
  String WITHOUT_ENABLED_FETCH_SCHEMA_OPTION_FOR_TARANTOOL_LESS_3_0_0 =
      "Can't use space or index names without enabled fetchSchema option for Tarantool version < 3.0.0";

  /**
   * <p>The method inserts a tuple object like the function
   * <a href="https://www.tarantool.io/en/doc/latest/reference/reference_lua/box_space/insert/">insert</a>
   * does.</p>
   * <p>Note: the API presented via
   * <a href="https://www.tarantool.io/en/doc/latest/reference/reference_lua/box_space/insert/">lua</a>
   * may differ from the API presented here since the API presented here uses the binary protocol directly. The
   * implementation uses standard {@link BaseOptions options}.</p>
   ...
   * </pre></blockquote>
   *
   * @param tuple tuple object for insertion. To create tuple object class follow example in {@link TarantoolBoxSpace}
   *              interface.
   ...
   * <p>Note: the API presented via
   * <a href="https://www.tarantool.io/en/doc/latest/reference/reference_lua/box_space/insert/">lua</a>
   * may differ from the API presented here since the API presented here uses the binary protocol directly.
   * {@link Options Options} parameter is passed as argument.</p>
   * <p>To use this method correctly, you can follow this example:</p>
   * <blockquote><pre>{@code
   * // Example from interface description.
   * Person person = new Person(1, true, "Petya");
   ...
   * <a href="https://www.tarantool.io/en/doc/latest/reference/reference_lua/box_space/insert/">lua</a>
   * may differ from the API presented here since the API presented here uses the binary protocol directly .
   * {@link Class} class of tuple object is passed as argument. The implementation uses standard
   * {@link BaseOptions options}.</p>
   * <p>To use this method correctly, you can follow this example:</p>
   * <blockquote><pre>{@code
   * // Example from interface description.
   * Person person = new Person(1, true, "Petya");
   ...
   * <a href="https://www.tarantool.io/en/doc/latest/reference/reference_lua/box_space/insert/">lua</a>
   * may differ from the API presented here since the API presented here uses the binary protocol directly .
   * {@link Class} class of tuple object and {@link Options Options} parameter are passed as argument.</p>
   * <p>To use this method correctly, you can follow this example:</p>
   * <blockquote><pre>{@code
   * // Example from interface description.
   * Person person = new Person(1, true, "Petya");
   ...
   * <a href="https://www.tarantool.io/en/doc/latest/reference/reference_lua/box_space/insert/">lua</a>
   * may differ from the API presented here since the API presented here uses the binary protocol directly .
   * {@link TypeReference} object is passed as argument.</p>
   * <p>To use this method correctly, you can follow this examples:</p>
   * <blockquote><pre>{@code
   * // Example from interface description.
   * Person person = new Person(1, true, "Petya");
   *
   ...
   * <a href="https://www.tarantool.io/en/doc/latest/reference/reference_lua/box_space/insert/">lua</a>
   * may differ from the API presented here since the API presented here uses the binary protocol directly .
   * {@link TypeReference} object and {@link Options Options} parameter are passed as argument.</p>
   * <p>To use this method correctly, you can follow this example:</p>
   * <blockquote><pre>{@code
   * // Example from interface description.
   * Person person = new Person(1, true, "Petya");
   ...
   * tuple of the specified Java type, otherwise this future will be completed exceptionally by exception.
   */
  <T> CompletableFuture<TarantoolResponse<Tuple<T>>> insert(Object tuple, Options options, TypeReference<T> entity);

  /**
   * <p>The method replaces a tuple object like the function
   * <a href="https://www.tarantool.io/en/doc/latest/reference/reference_lua/box_space/replace/">replace</a>
   * does.</p>
   * <p>Note: the API presented via
   * <a href="https://www.tarantool.io/en/doc/latest/reference/reference_lua/box_space/replace/">lua</a>
   * may differ from the API presented here since the API presented here uses the binary protocol directly . The
   * implementation uses standard {@link BaseOptions options}.</p>
   * <p>To use this method correctly, you can follow this example:</p>
   * <blockquote><pre>{@code
   ...
   * </pre></blockquote>
   *
   * @param tuple tuple object to replace. To create tuple object class follow example in {@link TarantoolBoxSpace}
   *              interface.
   ...
   * </pre></blockquote>
   *
   * @param tuple   tuple object for replace. To create tuple object class follow example in {@link TarantoolBoxSpace}
   *                interface.
   * @param options {@link BaseOptions option} object implementing base {@link Options options} interface.
   * @return {@link CompletableFuture} object. If successful - future is completed successfully with a one replaced
   * tuple represented as list of values, otherwise this future will be completed exceptionally by exception.
   ...
   * <a href="https://www.tarantool.io/en/doc/latest/reference/reference_lua/box_space/replace/">lua</a>
   * may differ from the API presented here since the API presented here uses the binary protocol directly
   * .{@link Class} class of tuple object is passed as argument.</p> The implementation uses standard
   * {@link BaseOptions options}.
   * <p>To use this method correctly, you can follow this example:</p>
   * <blockquote><pre>{@code
   * // Example from interface description.
   * Person person = new Person(1, true, "Petya");
   ...
   * tuple of the specified Java type, otherwise this future will be completed exceptionally by exception.
   */
  <T> CompletableFuture<TarantoolResponse<Tuple<T>>> replace(Object tuple, Options options, TypeReference<T> entity);

  /**
   * <p>The method selects a tuples object like the function
   * <a href="https://www.tarantool.io/en/doc/latest/reference/reference_lua/box_space/select/">select</a>
   * does.</p>
   * <p>Note: the API presented via
   * <a href="https://www.tarantool.io/en/doc/latest/reference/reference_lua/box_space/select/">lua</a>
   * may differ from the API presented here since the API presented here uses the binary protocol directly .The
   * implementation uses standard {@link SelectOptions options}.</p>
   * <p>To use this method correctly, you can follow this example:</p>
   * <blockquote><pre>{@code
   * // Creating TarantoolBoxClient object see in TarantoolBoxClientImpl class.
   * // Get specific space with your space name
   ...
   * @return {@link CompletableFuture} object of type {@link SelectResponse} that contains collection of tuples with
   * data and format if successful, otherwise - returns {@link CompletableFuture} with exception.
   */
  CompletableFuture<SelectResponse<List<Tuple<List<?>>>>> select(List<?> key);

  /**
   * <p>The method is similar to {@link #select(List)}.</p>
   *
   ...
   * <a href="https://www.tarantool.io/en/doc/latest/reference/reference_lua/box_space/select/">lua</a>
   * may differ from the API presented here since the API presented here uses the binary protocol directly
   * .{@link SelectOptions Options} parameter is passed as argument.</p>
   * <p>To use this method correctly, you can follow this example:</p>
   * <blockquote><pre>{@code
   ...
   * data and format if successful, otherwise - returns {@link CompletableFuture} with exception.
   */
  CompletableFuture<SelectResponse<List<Tuple<List<?>>>>> select(List<?> key, SelectOptions options);
   ...
   * <a href="https://www.tarantool.io/en/doc/latest/reference/reference_lua/box_space/select/">lua</a>
   * may differ from the API presented here since the API presented here uses the binary protocol directly
   * .{@link Class} class of tuple object is passed as argument.</p>
   * <p>To use this method correctly, you can follow this example:</p>
   * <blockquote><pre>{@code
   * // Creating TarantoolBoxClient object see in TarantoolBoxClientImpl class.
   * // Get specific space with your space id
   ...
   * @param entity {@link Class} class of tuple object.
   * @param <T>    tuple object class type.
   * @return {@link CompletableFuture} object. If successful - list of selected tuple objects represented as custom
   * class type, otherwise - returns {@link CompletableFuture} with exception.
   */
   ...
   * <a href="https://www.tarantool.io/en/doc/latest/reference/reference_lua/box_space/select/">lua</a>
   * may differ from the API presented here since the API presented here uses the binary protocol directly
   * .{@link Class} class and {@link SelectOptions options} parameter are passed as argument.</p>
   * <p>To use this method correctly, you can follow this example:</p>
   * <blockquote><pre>{@code
   * // Creating TarantoolBoxClient object see in TarantoolBoxClientImpl class.
   * // Get specific space with your space name
   ...
   * class type, otherwise - returns {@link CompletableFuture} with exception.
   */
  <T> CompletableFuture<SelectResponse<List<Tuple<T>>>> select(List<?> key, SelectOptions options, Class<T> entity);
   ...
   * <a href="https://www.tarantool.io/en/doc/latest/reference/reference_lua/box_space/select/">lua</a>
   * may differ from the API presented here since the API presented here uses the binary protocol directly
   * .{@link TypeReference} class is passed as argument.</p>
   * <p>To use this method correctly, you can follow this example:</p>
   * <blockquote><pre>{@code
   * // Creating TarantoolBoxClient object see in TarantoolBoxClientImpl class.
   * // Get specific space with your space name
   ...
   * @param <T>    tuple object class type.
   * @return {@link CompletableFuture} object. If successful - the future is completed successfully with a list of
   * selected tuples of the specified Java type, otherwise this future will be completed exceptionally by exception.
   */
   ...
   * <a href="https://www.tarantool.io/en/doc/latest/reference/reference_lua/box_space/select/">lua</a>
   * may differ from the API presented here since the API presented here uses the binary protocol directly
   * .{@link TypeReference} class and {@link  SelectOptions options} parameter are passed as argument.</p>
   * <p>To use this method correctly, you can follow this example:</p>
   * <blockquote><pre>{@code
   * // Creating TarantoolBoxClient object see in TarantoolBoxClientImpl class.
   * // Get specific space with your space name
   ...
   * selected tuples of the specified Java type, otherwise this future will be completed exceptionally by exception.
   */
  <T> CompletableFuture<SelectResponse<T>> select(List<?> key, SelectOptions options, TypeReference<T> entity);

  /**
   * <p>The method deletes a tuple object like the function
   * <a href="https://www.tarantool.io/en/doc/latest/reference/reference_lua/box_space/delete/">delete</a>
   * does.</p>
   * <p>Note: the API presented via
   * <a href="https://www.tarantool.io/en/doc/latest/reference/reference_lua/box_space/delete/">lua</a>
   * may differ from the API presented here since the API presented here uses the binary protocol directly .The
   * implementation uses standard {@link DeleteOptions options}.</p>
   * <p>To use this method correctly, you can follow this example:</p>
   * <blockquote><pre>{@code
   * // Creating TarantoolBoxClient object see in TarantoolBoxClientImpl class.
   * // Get specific space with your space name
  ...
  /**
   * <p>The method is similar to {@link #delete(List)}.</p>
   *
   ...
   * <a href="https://www.tarantool.io/en/doc/latest/reference/reference_lua/box_space/delete/">lua</a>
   * may differ from the API presented here since the API presented here uses the binary protocol directly
   * .{@link DeleteOptions Options} parameter is passed as argument.</p>
   * <p>To use this method correctly, you can follow this example:</p>
   * <blockquote><pre>{@code
   * // Choose the options you want to use
   ...
   * <a href="https://www.tarantool.io/en/doc/latest/reference/reference_lua/box_space/delete/">lua</a>
   * may differ from the API presented here since the API presented here uses the binary protocol directly
   * .{@link Class} class and {@link DeleteOptions options} parameter are passed as argument.</p>
   * <p>To use this method correctly, you can follow this example:</p>
   * <blockquote><pre>{@code
   * // Creating TarantoolBoxClient object see in TarantoolBoxClientImpl class.
   * // Get specific space with your space name
   ...
   * <a href="https://www.tarantool.io/en/doc/latest/reference/reference_lua/box_space/delete/">lua</a>
   * may differ from the API presented here since the API presented here uses the binary protocol directly
   * .{@link TypeReference} class and {@link  DeleteOptions options} parameter are passed as argument.</p>
   * <p>To use this method correctly, you can follow this example:</p>
   * <blockquote><pre>{@code
   * // Creating TarantoolBoxClient object see in TarantoolBoxClientImpl class.
   * // Get specific space with your space name
   ...
   * tuple of the specified Java type, otherwise this future will be completed exceptionally by exception.
   */
  <T> CompletableFuture<TarantoolResponse<Tuple<T>>> delete(List<?> key, DeleteOptions options, TypeReference<T> entity);

  /**
   * <p>The method updates a tuple like the function
   * <a href="https://www.tarantool.io/en/doc/latest/reference/reference_lua/box_space/update/">update</a>
   * does.</p>
   * <p>Note: the Lua API may differ from this API since Java driver uses the binary protocol directly.</p>
   * <p>The implementation uses default instance of {@link UpdateOptions options}.</p>
   * <p>Example:</p>
   * <blockquote><pre>{@code
   ...
   * represented as list of values, otherwise this future will be completed exceptionally by exception.
   */
  CompletableFuture<Tuple<List<?>>> update(List<?> key, List<List<?>> operations, UpdateOptions options);

  CompletableFuture<Tuple<List<?>>> update(List<?> key, Operations operations, UpdateOptions options);
   ...
   * represented as custom class type, otherwise this future will be completed exceptionally by exception.
   */
  <T> CompletableFuture<Tuple<T>> update(List<?> key, List<List<?>> operations, UpdateOptions options, Class<T> entity);

  <T> CompletableFuture<Tuple<T>> update(List<?> key, Operations operations, UpdateOptions options, Class<T> entity);

  /**
   * <p>The method updates a tuple object the function
   * <a href="https://www.tarantool.io/en/doc/latest/reference/reference_lua/box_space/update/">update</a>
   * does.</p>
   * <p>Note: the Lua API may differ from this API since Java driver uses the binary protocol directly.</p>
   * <p>The implementation uses default instance of {@link UpdateOptions options}.</p>
   ...
   * tuple of the specified Java type, otherwise this future will be completed exceptionally by exception.
   */
  <T> CompletableFuture<TarantoolResponse<Tuple<T>>> update(List<?> key, List<List<?>> operations, TypeReference<T> entity);

  <T> CompletableFuture<TarantoolResponse<Tuple<T>>> update(List<?> key, Operations operations, TypeReference<T> entity);
   ...
   * tuple of the specified Java type, otherwise this future will be completed exceptionally by exception.
   */
  <T> CompletableFuture<TarantoolResponse<Tuple<T>>> update(List<?> key,
  ...
  /**
   * <p>The method upserts a tuple like the function
   * <a href="https://www.tarantool.io/en/doc/latest/reference/reference_lua/box_space/upsert/">upsert</a>
   * does.</p>
   * <p>Note: the Lua API may differ from this API since Java driver uses the binary protocol directly.</p>
   * <p>The implementation uses default instance of {@link UpdateOptions options}.</p>
   * <p>Example:</p>

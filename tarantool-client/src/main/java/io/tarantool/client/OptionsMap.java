...
public interface OptionsMap extends Options {
  ...
  /**
   * <p>The method returns a map whose keys are the names of options, and whose values are the values of
   * options. Example: for  options method can return follow map:</p>
   * <blockquote><pre>{@code
   *      {

...
public final class TarantoolContainerClientHelper {
  ...
  public TarantoolContainerClientHelper(TarantoolContainerOperations<? extends Container<?>> container) {
    this.container = container;
  }

  public Container.ExecResult executeScript(String scriptResourcePath, org.testcontainers.containers.utils.SslContext sslContext)
  ...
  public <T> T executeScriptDecoded(String scriptResourcePath, org.testcontainers.containers.utils.SslContext sslContext)
  ...
  public Container.ExecResult executeCommand(String command, org.testcontainers.containers.utils.SslContext sslContext)
      throws IOException, InterruptedException {
    if (!container.isRunning()) {

...
public final class TarantoolContainerClientHelper {
  ...
  public Container.ExecResult executeScript(
      String scriptResourcePath, org.testcontainers.containers.utils.SslContext sslContext)
  ...
  public <T> T executeScriptDecoded(
      String scriptResourcePath, org.testcontainers.containers.utils.SslContext sslContext)

...
package io.tarantool.spring.data34.utils.core;
...
public interface GenericPaginationMethods<T, ID> {
  ...
  List<T> findPersonByIdGreaterThanEqual(int id, Limit limit);

  List<T> findTop4ByIdGreaterThanEqual(int id, Limit limit);
}

...
public class TarantoolBeanNames {

  public static final String DEFAULT_TARANTOOL_CRUD_CLIENT_BEAN_REF = "tarantoolCrudClient";

  public static final String DEFAULT_TARANTOOL_BOX_CLIENT_BEAN_REF = "tarantoolBoxClient";

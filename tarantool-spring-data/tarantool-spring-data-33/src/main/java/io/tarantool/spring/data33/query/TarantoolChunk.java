...
abstract class TarantoolChunk<T> implements Slice<T>, Serializable {
  ...
  /**
   * Creates a new {@link TarantoolChunk} with the given content and the given governing {@link TarantoolPageable}.
   *
   ...
   * current {@link Slice} is already the last one or when data content is empty. Clients should check
   * {@link #hasNext()} and {@link  #hasContent()} before calling this method.
   *
   ...
   * current {@link Slice} is already the first one or data content is empty. Clients should check
   * {@link #hasPrevious()} and {@link #hasContent()} before calling this method.
   *
